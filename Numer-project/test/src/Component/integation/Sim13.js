...
class Sim13 extends Component {
    ...
    compute = () => {
        ...
        var result1 = [];
        var output=(code.evaluate(scopea)+(4*code.evaluate(scopeah))+code.evaluate(scopeb))*h/3
